            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white tracking-tight">
                  Physics <span className="text-cyan-400">Simulator</span>
                </h1>
              </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 items-end">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-gray-400 flex justify-between">
                  ...
                  <span className="text-cyan-400">
                    {isPlaying
                      ? globalSettings.timeScale.toFixed(1) + "x"
                      : "PAUSED"}
                  </span>
                </label>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-gray-400 flex justify-between">
                  <span>Gravity</span>
                  <span className="text-cyan-400">
                    {globalSettings.gravityMultiplier.toFixed(1)}x
                  </span>
                </label>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-gray-400 flex justify-between">
                  <span>Rotation</span>
                  <span className="text-cyan-400">
                    {globalSettings.rotationMultiplier.toFixed(1)}x
                  </span>
                </label>
                <div className="flex items-center h-7">
                  <input
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-gray-400 flex justify-between">
                  ...
                  <span className="text-cyan-400">
                    {globalSettings.bouncinessMultiplier.toFixed(1)}x
                  </span>
                </label>
                <div className="flex items-center h-7">
                  <input
                    ...
                    onChange={(e) =>
                      setGlobalSettings((p) => ({
                        ...p,
                        bouncinessMultiplier: parseFloat(e.target.value),
                      }))
                    }
                    className="w-full h-1.5 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cyan-500"
                  />
